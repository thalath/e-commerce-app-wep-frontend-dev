...
//
//   const producModel = Convert.toProducModel(json);
//
...
function toProducModel(json) {
    return cast(JSON.parse(json), r("ProducModel"));
}

function producModelToJson(value) {
    return JSON.stringify(uncast(value, r("ProducModel")), null, 2);
}
...
export { toProducModel, producModelToJson };